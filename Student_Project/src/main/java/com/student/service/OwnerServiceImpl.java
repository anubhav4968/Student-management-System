...
public class OwnerServiceImpl implements OwnerService{
	...
	//Student
		...
		public StudentDto getStudents(Integer student_id) {
			Student user = this.studentRepo.findById(student_id).orElseThrow(()->new ResourceNotFoundException("User" ,"Id",student_id));
		...
		public AddressDto addAddress(AddressDto addressDto, Integer student_id) {
			...
			Student student = this.studentRepo.findById(student_id).orElseThrow(()->new ResourceNotFoundException("Student", "StudentId", student_id));
